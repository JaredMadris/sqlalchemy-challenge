...
def home():
    return (f"Welcome to Surf's Up!: Hawaii Climate API<br/>"
            ...
            f"/api/v1.0/precipitaton         (latest year of precipitation data)<br/>"
            f"/api/v1.0/temperature          (latest year of temperature data)<br/>"
            f"------------------------------------------------<br/>"
            f"datesearch<br/>"
            f"/api/v1.0/datesearch/yyyy-mm-dd                  (low, high, and average temp for date given and each date after)<br/>"
            f"/api/v1.0/datesearch/yyyy-mm-dd/yyyy-mm-dd       (low, high, and average temp for date given and each date up to and including end date)<br/>"
            f"-----------------------------------------<br/>"
            f"Data is available from 2010-01-01 to 2017-08-23 <br/>"
            f"-------------------------------------------")
